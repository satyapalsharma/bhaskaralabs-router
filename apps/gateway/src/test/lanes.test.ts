...
const allHealthy = (): LaneHealth => {
  const h: LaneHealth = {};
  for (const p of ["hyper", "agnes", "stepfun", "camel", "llmgateway", "electronhub", "openference", "pareto", "teamorouter", "opencode", "openrouter", "openrouter2", "claudin", "orca", "orca2", "agnes2"]) {
    h[p] = true;
  }
  return h;
};
